...
@section('navbar')
    ...
    <div class="container">
      ...
      <div id="navbar" class="navbar-collapse collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="#" id="licenseManag" class="main-bar">Gestione licenze</a></li>
  ...
  <script type="text/javascript">
    ...
    $('#activationProc').click(function() {
      $.ajax({ url: 'console/admin.clients.activating.container',
    ...
    $('#licenseManag').click(function() {
      $.ajax({ url: 'console/admin.activation_codes.container',
         data: {page: 'license_procedures'},
         type: 'post',
         success: function(output) {
           $('#content').html(output);
          },
    ...
    $('#settings').click(function() {
      $.ajax({ url: 'console/admin.settings.container',
         data: {page: 'settings'},
         type: 'post',
         success: function(output) {
           $('#content').html(output);
    ...
    $(".nav a").on("click", function(){
      if ($(this).attr('id') != 'clientDropdown') {
        if ($(this).attr('id') == 'activationProc' || $(this).attr('id') == 'licenseManag') {
