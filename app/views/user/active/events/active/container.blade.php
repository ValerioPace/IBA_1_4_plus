...
@if ($events > 0)
	...
	<div class="row">
		<div class="col-xs-12 col-md-6">
			<div class="panel panel-default">
				<div class="panel-heading">Tutti gli eventi attivi</div>
				<div class="panel-body" id="active_events_list">  <!-- style="min-height: 500; max-height: 500; overflow-y: scroll;" -->
		...
		<div class="col-xs-12 col-md-6">
			<div class="panel panel-default">
				...
				<div class="panel-body" id="active_event_details">
	...
	<script type="text/javascript">	
		...
		$(document).ready(function() {
			$.ajax({ url: 'console/user.active.events.active.list',
				type: 'get',
	...
	<div class="panel panel-default">
		<div class="panel-body">
			<div class="alert alert-info" role="alert">
				Non sono presenti eventi attivi... <a href="#" class="alert-link" id="new_event_redirect">Creane uno!</a>
			</div>
		</div>
	</div>
